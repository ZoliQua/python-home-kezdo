...
import pandas as pd
go_data = pd.read_csv("data/cluster_source_202202.csv", sep=",", usecols=["GO_ID", "SPECIES", "local_cc_10", "edges_10"])
...
g = sns.clustermap(go_data_pivot, figsize=(10, 10), annot=False, cmap="YlGnBu", mask=(go_data_pivot==0), standard_scale=1)
# row_cluster=False,
print(dir(g))
#display(g.data())
print(g.data2d.T)
